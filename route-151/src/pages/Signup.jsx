      ...
      <main className="flex-grow flex items-center justify-center px-4 py-8">
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            <h1 className="text-3xl font-bold gradient-text">Begin Your Pokémon Journey</h1>
            <p className="mt-2 text-slate-400">
              Create an account to start collecting, battling, and trading
            </p>
          </div>
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="form-control">
                  ...
                  <input type="text" placeholder="Ash" className="input input-bordered bg-slate-800 border-slate-700 text-white" />
                </div>
                ...
                <div className="form-control">
                  ...
                  <input type="text" placeholder="Ketchum" className="input input-bordered bg-slate-800 border-slate-700 text-white" />
                </div>
              </div>
              ...
              <div className="form-control">
                ...
                <input type="text" placeholder="PokeMaster99" className="input input-bordered bg-slate-800 border-slate-700 text-white" />
              </div>
              ...
              <div className="form-control">
                ...
                <input type="email" placeholder="ash.ketchum@pallet.town" className="input input-bordered bg-slate-800 border-slate-700 text-white" />
              </div>
              ...
              <div className="form-control">
                <label className="cursor-pointer flex items-center gap-2">
                  ...
                  <span className="text-slate-300">I agree to the <a href="#" className="text-indigo-400 hover:underline">Terms and Conditions</a></span>
                </label>
              </div>

              <div className="form-control mt-6">
                <button className="gradient-button w-full">Create Account</button>
              </div>
            </form>
